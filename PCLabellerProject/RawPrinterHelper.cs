...
namespace PCLabellerProject
{
    ...
    {
        public static bool OpenPrinter(string szPrinter, out IntPtr hPrinter, IntPtr pd)
        {
            return NativeMethods.OpenPrinter(szPrinter,out hPrinter, pd);
        }

        public static bool ClosePrinter(IntPtr hPrinter)
        {
            return NativeMethods.ClosePrinter(hPrinter);
        }
        ...
        {
            return NativeMethods.EndDocPrinter(hPrinter);
        }

        public static bool StartPagePrinter(IntPtr hPrinter)
        {
            return NativeMethods.StartPagePrinter(hPrinter);
        }

        public static bool EndPagePrinter(IntPtr hPrinter)
        {
            return NativeMethods.EndPagePrinter(hPrinter);
        }
